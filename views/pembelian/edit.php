    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <?= form_open('', [], ['id_pembelian' => $pembelian['id_pembelian']]); ?>
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('no_pembelian', $pembelian['no_pembelian']); ?>" name="no_pembelian" id="no_pembelian" type="text" class="form-control" placeholder="No Pembelian...">
                        </div>
                        <?= form_error('no_pembelian', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="tgl_pembelian">Tanggal Pembelian</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="far fa-fw fa-calendar-alt"></i></span>
                            </div>
                            <input value="<?= set_value('tgl_pembelian', $pembelian['tgl_pembelian']); ?>" name="tgl_pembelian" id="tgl_pembelian" type="date" class="form-control" placeholder="Tanggal ...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('total', $pembelian['total']); ?>" name="total" id="total" type="text" class="form-control" placeholder="Total ...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('terbayar', $pembelian['terbayar']); ?>" name="terbayar" id="terbayar" type="text" class="form-control" placeholder="Terbayar ...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('sisa', $pembelian['sisa']); ?>" name="sisa" id="sisa" type="text" class="form-control" placeholder="Sisa ...">
                        </div>
