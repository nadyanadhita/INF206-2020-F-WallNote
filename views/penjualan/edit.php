    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <?= form_open('', [], ['id_penjualan' => $penjualan['id_penjualan']]); ?>
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('no_penjualan', $penjualan['no_penjualan']); ?>" name="no_penjualan" id="no_penjualan" type="text" class="form-control" placeholder="No Penjualan...">
                        </div>
                        <?= form_error('no_penjualan', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="tgl_penjualan">Tanggal Penjualan</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="far fa-fw fa-calendar-alt"></i></span>
                            </div>
                            <input value="<?= set_value('tgl_penjualan', $penjualan['tgl_penjualan']); ?>" name="tgl_penjualan" id="tgl_penjualan" type="date" class="form-control" placeholder="Tanggal ...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('total', $penjualan['total']); ?>" name="total" id="total" type="text" class="form-control" placeholder="Total ...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('terbayar', $penjualan['terbayar']); ?>" name="terbayar" id="terbayar" type="text" class="form-control" placeholder="Terbayar ...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('sisa', $penjualan['sisa']); ?>" name="sisa" id="sisa" type="text" class="form-control" placeholder="Sisa ...">
                        </div>
