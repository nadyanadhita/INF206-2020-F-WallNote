    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <?= form_open('', [], ['stok' => 0, 'id_opname' => $opname['id_opname']]); ?>
                        ...
                        <div class="input-group">
                            <select name="barang_id" id="barang_id" class="custom-select">
                                ...
                                <?php foreach ($barang as $j) : ?>
                                    <option <?= $opname['barang_id'] == $j['id_barang'] ? 'selected' : ''; ?> <?= set_select('barang_id', $j['id_barang']) ?> value="<?= $j['id_barang'] ?>"><?= $j['nama_barang'] ?></option>
                                <?php endforeach; ?>
                            </select>
