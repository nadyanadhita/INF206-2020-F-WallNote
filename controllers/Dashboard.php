...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['terbayar'] = $this->admin->sum('penjualan', 'terbayar');
        $data['barang_masuk'] = $this->admin->count('barang_masuk');
        $data['barang_keluar'] = $this->admin->count('barang_keluar');
        $data['total'] = $this->admin->sum('pembelian', 'total');
        $data['penjualan'] = $this->admin->sum('penjualan', 'sisa');
        $data['pembelian'] = $this->admin->sum('pembelian', 'sisa');
